...
var _createGlobalState = /*#__PURE__*/createGlobalState({
  container: undefined,
...
var ScrollContainer = function ScrollContainer(_ref) {
  ...
  var scrollContainer = useRef(null); // @ts-ignore: Unreachable code error
...
var HorizontalSection = function HorizontalSection(_ref) {
  ...
  var pinWrap = useRef(null);
  var animationWrap = useRef(null);
  ...
  useLayoutEffect(function () {
    ...
    if (animationWrap.current) {
      ...
      fromTo = gsap.fromTo(animationWrap.current, {
        x: function x() {
...
var ParallaxImage = function ParallaxImage(_ref) {
  ...
  var parallaxImage = useRef(null);
  var parallaxImageInner = useRef(null);
  ...
  return React.createElement("figure", Object.assign({
...
var SequenceSection = function SequenceSection(_ref) {
  ...
  var sequenceSection = useRef(null);
  var sequenceSectionCanvas = useRef(null);
